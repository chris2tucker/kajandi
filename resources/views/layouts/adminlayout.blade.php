...
.dt-buttons button {
    ...
    border: 1px solid #67d3e0 !important;
}
    </style>
    <!-- -------------- Meta and Title -------------- -->
    <meta charset="utf-8">
    ...
    <!-- -------------- CSS - allcp forms -------------- -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/allcp/forms/css/forms.min.css') }}">
    ...
    <link rel="shortcut icon" href="/assets/img/favicon.ico">
        ...
        <!-- -------------- Datatables CSS -------------- -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/js/plugins/datatables/media/css/dataTables.bootstrap.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{URL::asset('assets/js/plugins/datatables/extensions/Editor/css/dataTables.editor.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{URL::asset('assets/js/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css') }}">
...
<script src="{{URL::asset('assets/js/plugins/jvectormap/assets/jquery-jvectormap-world-mill-en.js') }}"></script>

<!-- -------------- Datatables JS -------------- -->
<script src="{{URL::asset('assets/js/plugins/datatables/media/js/jquery.dataTables.js') }}"></script>
<script src="{{URL::asset('assets/js/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js') }}"></script>
<script src="{{URL::asset('assets/js/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js') }}"></script>
<script src="{{URL::asset('assets/js/plugins/datatables/media/js/dataTables.bootstrap.js') }}"></script>
...
<!-- -------------- FileUpload JS -------------- -->
<script src="{{URL::asset('assets/js/plugins/fileupload/fileupload.js') }}"></script>
<script src="{{URL::asset('assets/js/plugins/holder/holder.min.js') }}"></script>


<!-- -------------- Page JS -------------- -->

<script src="{{URL::asset('https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js') }}"></script>
<script src="{{URL::asset('assets/js/demo/charts/highcharts.js') }}"></script>
<script src="{{URL::asset('https://cdn.datatables.net/buttons/1.5.2/js/dataTables.buttons.min.js') }}"></script>
<script src="{{URL::asset('https://cdn.datatables.net/buttons/1.5.2/js/buttons.flash.min.js') }}"></script>
...
<script src="{{URL::asset('https://cdn.datatables.net/buttons/1.5.2/js/buttons.html5.min.js') }}"></script>
<script src="{{URL::asset('https://cdn.datatables.net/buttons/1.5.2/js/buttons.print.min.js ') }}"></script>
