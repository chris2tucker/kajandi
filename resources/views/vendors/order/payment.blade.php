...
<style type="text/css">
 ...
 <header id="topbar" class="alt">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><em class="ti-user mr5"></em>Payment Accept</h3>
                </div>
            </div>
                                    ...
                                    @foreach($orders as $key=>$order)
                                        @foreach($order->orderdetails as $orderdetail)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ App\Http\Controllers\HomeController::converter($orderdetail->totalprice) }}</td>
                                                <td>
                                                     @if($order->payment == 'yes')
                                                         <h5  style='padding: 5px; text-align: center'><a href="{{ URL::to('order/paymentdeactive',$order->id) }}" class="btn btn-primary">Pending</a></h5>
                                                        @else
                                                        <h5  style='padding: 5px; text-align: center'><a href="{{ URL::to('order/paymentactive',$order->id) }}" class="btn btn-warning">Accept</a></h5>
                                                    @endif
                                                </td>
