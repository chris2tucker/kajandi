                ...
                <div class="allcp-form">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="{{ URL::to('vendors/model/create') }}" class="btn btn-bordered btn-primary mb5">Add Model</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-striped mg-t" id="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$key->name}}</td> 
                                                <td>  
                                                    <a href="{{ URL::to('vendors/model/' . $key->id . '/edit') }}" class="btn btn-primary btn-xs edit"><span class="ti-pencil"></span> Edit</a>


                                               <!--     {{ Form::open(array('url' => 'vendors/model/' . $key->id, 'class' => 'pull-left delete ')) }}
