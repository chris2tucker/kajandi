...
@section('content')
    ...
    @if($nopayment)
        <div class="container" style="width: 90%">
            No outstanding or due payment is present.
        </div>
    @else
        <div class="container" style="width: 90%">
    ...
    margin-bottom: 40px;"><img src="{{url('img/logo-2.png')}}" alt="" style="    height: 100px;"></div>
            ...
            <div class="row row-col-gap">
                <div class="col-md-12">
                   <h3 class="widget-title">Order Information</h3>
                    <p>To complete Transaction for Order ({{$ordernumber}}), transfer or pay the total amount ({{App\Http\Controllers\HomeController::converter($amount)}}) in to Kajandi bank account.</p>
                    ...
                    <div class="box">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Total Amount</td>
                                    <td>{{App\Http\Controllers\HomeController::converter($amount)}}</td>
                                </tr> 
                            </tbody>
                        </table>
                    </div>
            ...
            <h6>Total Amount={{App\Http\Controllers\HomeController::converter($amount)}}</h6>
