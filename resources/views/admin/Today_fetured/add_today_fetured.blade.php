    ...
    <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Add Today Featured</li>
                </ol>
            </div>
                    ...
                    <div class="allcp-form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Add Today Featured
                                </div>
                            </div>
                            ...
                            <form method="post" action="{{ url('admin/save_today_featured') }}"  enctype="multipart/form-data">
                                {{ csrf_field() }}
