                                        ...
                                        <tbody>
                                          ...
                                          @foreach($manufacture as $key)
                                            <tr>
                                                ...
                                                <td>  
                                                    <a href="{{ URL::to('admin/manufacture/' . $key->id . '/edit') }}" class="btn btn-primary btn-xs edit"><span class="ti-pencil"></span> Edit</a>
                                                    

                                                     {{ Form::open(array('url' => 'admin/manufacture/' . $key->id, 'class' => 'pull-left delete ')) }}
