...
<header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Edit  Adv Section 1</li>
                </ol>
            </div>
                    ...
                    <div class="allcp-form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Edit Adv  Section 1
                                </div>
                            </div>
                            ...
                            {{ Form::model($adv_sec_1, array('url' => array('admin/adv_sec_1/update', $adv_sec_1->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <select id="country" name="vendor" class="vendor form-control">
                                                ...
                                                @foreach($vendor as $key=>$val)
                                                    <option value="{{$key}}" @if($adv_sec_1->vendor_id==$key) selected="selected" @endif>{{$val}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <select id="country" name="product_name" class="product_name form-control">
                                                ...
                                                <option value="{{$key->id}}" @if($adv_sec_1->product_id==$key) selected="selected" @endif>{{$key->name}}</option>
