            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-link">
                        <a href="{{url('admin/vendorproduct')}}">Vendors Product</a>
                    </li>
                ...
                <div class="mw1000 center-block">
                    ...
                    <div class="allcp-form">
                        <div class="panel">
                            ...
                            @endif
                            @if($vendor_product->dimension_per_unit_weight==NULL || $vendor_product->dimension_per_unit_volume==NULL)
                            <p class="alert alert-danger alert-dismissable fade in" id="alert_for_auto" style="display: none;">Please add wieght and volunm</p>
                           @endif
                            ...
                            <form method="POST" action="{{ url('/admin/updateproduct/'.$vendor_product->product_id) }}" class="" id="form-product" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                             ...
                                             <div class="row">
                                                <label for="store-name" class="col-sm-2 control-label small">Vendor:<font color="red">*</font></label>
                                                    <div class="col-sm-10 ph10">
                                                            <select id="vendor" name="vendor" class="form-control chosen">
                            ...
                            <!-- ---------------------------------------------End First Tab General---------------------------------------------------->
                                        ...
                                        <div class="tab-pane fade" id="data">
                                             ...
                                             <div class="form-group">
                                                <div class="section row mb10">
                                                    <label for="store-name" class="col-sm-2 control-label small">Catagory: <font color="red">*</font></label>
                                                        <div class="col-sm-10 ph10">
                                                                <select id="catagory" name="category" class="form-control">
                                             ...
                                             <div class="form-group">
                                                 <div class="section row mb10">
                                                    <label for="store-name" class="col-sm-2 control-label small">Sub Catagory: <font color="red">*</font></label>
                                                        <div class="col-sm-10 ph10">
                                                                <select id="subcatagory" name="subcategory" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                  <select data-placeholder="Please Select Accessories..."  multiple class="chosen" name="accessories[]" > 
                        ...
                        <!-- ---------------------------------End Tab Data----------------------------------------- -->
                                        ...
                                        <div class="tab-pane fade" id="payment_delvery_information">
                                           ...
                                           <div class="section row mb10">
                                            ...
                                            <div class="section row mb10">
                                            <label for="store-name" class="col-sm-2 control-label small">Delivery Rate:</label>
                                            <div class="col-sm-3 ph10">
                                    ...
                                    <div class="tab-pane fade" id="image">
                                     ...
                                     <div class="tab-pane fade" id="shipping">
                                       ...
                                       <div class="section row mb10">
                                          <label for="store-name" class="col-sm-2 control-label small">Shipping type: <font color="red">*</font></label>
                                                    <div class="col-sm-10 ph10">
                                                            <select id="country" name="shipping" class="form-control">
                                                                
                                                                <option value=""  disabled selected>Select A Shipping Method</option>
                                                                
                                                                <option value="Vendor_shipping" 
                                                                @if($shipping)
                                                                @if($shipping->shipping_type=='Vendor_shipping') selected="selected" @endif
                                                                @endif>Vendor Shipping</option>
                                                                <option value="mannual_shipping" 
                                                                @if($shipping)
                                                                @if($shipping->shipping_type=='mannual_shipping') selected="selected" @endif
                                                                @endif>Manual shipping</option>
                                                                <option value="company_shipping" 
                                                                @if($shipping)
                                                                @if($shipping->shipping_type=='company_shipping') selected="selected" @endif
                                                                @endif>Company shipping</option>
                                                                  <option value="free" 
                                                                  @if($shipping)
                                                                  @if($shipping->shipping_type=='free') selected="selected" @endif
                                                                  @endif>Free Shipping</option>
                                     ...
                                     <div class="tab-pane fade" id="specification">
                                        ...
                                        @endphp
                                       <div class="section row mb10">
                                           <textarea name="specification" id="summernote">{!!$product->additional_specification!!}</textarea>
                                       </div>
                                    ...
                                    <button type="submit" class="btn btn-primary" style="margin-top: 10px;">Save</button>
                                      ...
                                      <div class="table-responsive" id="mannual_shippings"  @if($shipping) @if($shipping->shipping_type=='mannual_shipping')  style="display: blok;" @else  style="display:none;" @endif
                                       @else style="display:none;" @endif>
                                        <h2>Mannual shiping</h2>
                            <table class="table table-bordered table-striped mg-t" id="table">
                                ...
                                <tbody>
                                    @php
                                    $mannual_shippings=App\mannual_shipping::where('vendorproduct_id','=',$vendor_product->product_id)->get();
                                  
                                    @endphp
                                    @foreach($mannual_shippings as $mannual)
                                    <tr>
                                        <td>{{$mannual->city}}</td>
                                        <td>{{$mannual->shipping}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
<script>
    $(document).ready(function() {
        ...
        $("select[name='shipping']").change(function(){
            var value=$(this).val();
            if(value=='company_shipping'){
                $("#alert_for_auto").show();
            }
            else if(value=='mannual_shipping'){
                $("#mannual_shippings").show();
            }
        });
