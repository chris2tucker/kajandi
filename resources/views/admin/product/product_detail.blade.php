                                                        ...
                                                        <div class="box">
                                                            ...
                                                            class="table table-striped product-page-features-table">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Part Number:</td>
                                                                        <td>{{$vendor_product->part_number}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Condition:</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{App\Http\Controllers\HomeController::converter($vendor_product->price_for_optional_unit) }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Instant Price:</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{App\Http\Controllers\HomeController::converter($vendor_product->deliveryratestate)}}</td>
                                                                        
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Delivery Within Geographic Range:</td>
                                                                        <td>{{App\Http\Controllers\HomeController::converter($vendor_product->deliveryrateoutstatewithgeo)  }}</td>
                                                                        
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Delivery Out Geographic Range:</td>
                                                                        <td>{{App\Http\Controllers\HomeController::converter($vendor_product->deliveryrateoutsidegeo)  }}</td>
                                                                    ...
                                                                    $vendor=App\vendorproduct::where('product_id','=',$vendor_product->product_id)->first();
                                                                    $shipping=App\shipping::where('vendorproduct_id','=',$vendor->id)->first();
                                                                    @endphp
                                                                     <tr>
                                                                        <td>Shipping Type :</td>
                                                                        <td>{{$shipping ? $shipping->shipping_type : ''}}</td>
