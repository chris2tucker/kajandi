                ...
                <div class="mw1000 center-block">
                    ...
                    <div class="allcp-form">
                        <div class="panel">
                            ...
                            <form method="POST" action="{{ url('/admin/store_product') }}" class="" id="form-product" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                        ...
                                        <div class="tab-pane fade" id="data">
                                            ...
                                            <div class="form-group">
                                                <div class="row ">
                                                    <label for="store-name" class="col-sm-2 control-label small">Manufacture: <font color="red">*</font></label>
                                                            <div class="col-sm-10 ph10">
                                                                <select id="drop" name="manufacturer" class="form-control chosen" style="width: 100%;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="store-name" class="col-sm-2 control-label small">Model: <font color="red">*</font></label>
                                                    <div class="col-sm-10 ph10">
                                                            <select id="drop" name="model" class="form-control chosen" style="width: 100% !mportant;">
