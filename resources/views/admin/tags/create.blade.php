...
<header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Add Tag</li>
                </ol>
            </div>
                            ...
                            <form method="post" action="{{ url('admin/add_tag') }}"  enctype="multipart/form-data">
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="name" id="business-name" class="form-control" placeholder="Tag Name">
                                    </div>
                                </div>
