...
$(document).on('change','.vendor',function(e){
        ...
        $.ajax({
            ...
            var totalprice = data.TotalPrice_with_commission.totalprice_with_comission.toFixed(2);
            var totalprice_without_commission = data.TotalPrice_without_commission.totalprice_without_comission.toFixed(2);
            var total_commission = data.Total_commission.total_comission.toFixed(2);
        $('.total_price_with_commission').html(totalprice);
        $('.total_price_without_commission').html(totalprice_without_commission);
