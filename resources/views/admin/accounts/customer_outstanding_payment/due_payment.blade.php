...
<head>
    ...
    <title>Customer Outstanding Detail</title>
            ...
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-link">
                        <a href="{{url('admin/due_customer_payment')}}">Customer Due Payment</a>
                    </li>
...
$(document).on('change','.customer',function(e){
        ...
        var url = ajaxurl+'admin/due_detail_order';
        ...
        $.ajax({
            ...
            $('.outstanding_payment').createTable(data.due, {
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    <div class="form-group">
                                                <div class="row ">
                                                <label for="store-name" class="col-sm-2 control-label small">Customer: <font color="red">*</font></label>
                                                    <div class="col-sm-10 ph10">
                                                            <select id="drop" name="condition" class="form-control chosen customer">
