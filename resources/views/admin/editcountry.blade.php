                ...
                <div class="mw1000 center-block">
                    ...
                    <div class="allcp-form">
                        <div class="panel">
                            ...
                            <form method="post" action="{{ url('admin/country/edit/'.$city->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}

                            
                                <div class="section row mb10">
                                    <label for="store-address" class="col-sm-2 control-label small">Country</label>

                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="city" id="city" class="form-control" value="{{$city->name}}" placeholder="Country"> 
                                    </div>
                                </div>
