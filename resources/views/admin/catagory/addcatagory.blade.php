                            ...
                            <form method="post" action="{{ url('admin/addcategory') }}"  enctype="multipart/form-data">
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="name" id="business-name" class="form-control" placeholder="Category Name">
                                    </div>
                                </div>

                                <div class="section row mb10">
                                    <label for="store-name" class="col-sm-2 control-label small">Category Description:<font color="red">*</font></label>

                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="category_description" id="business-name" class="form-control" placeholder="Category Description">
                                    </div>
                                </div>
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="catagory_abbreviation" id="business-name" class="form-control" placeholder="Category Abbreviation"> 
                                    </div>
                                </div>
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">  
                                            <input type="radio" name="add_menu"  class="" value="yes"> Yes
                                            &nbsp;
                                            <input type="radio" name="add_menu"  class="" value="no" checked="checked"> No
                                    </div>
                                </div>
