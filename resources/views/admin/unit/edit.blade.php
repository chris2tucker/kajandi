...
<header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Edit Unti</li>
                </ol>
            </div>
                    ...
                    <div class="allcp-form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Edit Unit
                                </div>
                            </div>
                            ...
                            <form method="post" action="{{ url('admin/unit/'.$unit->id) }}"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="unit" id="business-name" class="form-control" placeholder="Unit Name" value="{{$unit->unit}}">
                                    </div>
                                </div>
