                    ...
                    <div class="allcp-form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Add Banner
                                </div>
                            </div>
                            ...
                            <form method="post" action="{{ url('admin/banner') }}"  enctype="multipart/form-data">
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="banar_text" id="business-name" class="form-control" placeholder="Banner Text" >
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="banar_url" id="business-name" class="form-control" placeholder="Banner Url" >
