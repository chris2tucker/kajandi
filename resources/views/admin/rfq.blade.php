                        ...
                        <div class="panel panel-default">
                                    ...
                                    <table class="table table-bordered table-striped mg-t" id="table">
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                ...
                                                <td>@if($bids==NULL)<te type="text" name="bidnote" required> @else {{$bids->note}} @endif</td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="product_name" value="{{$rf->product_certificate}}"   autofocus readonly>
                                    ...
                                    @php
                                    $getusers=App\rfqvendor::where('rfq_id','=',$rf->id)->get();
                                    @endphp
                                    <ul class="col col-sm-12">
                                        @foreach($getusers as $user)
                                        <li style="display: inline-block;padding: 40px">{{App\User::find($user->vendor_id)->name}}</li>
                                        <li style="display: inline-block;padding: 40px">{{$user->bid}}</li>
                                        <li style="display: inline;padding: 40px;">@if($user->selected) selected @endif</li>
                                        @endforeach
                                    </ul>
