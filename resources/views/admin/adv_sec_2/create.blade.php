...
<header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Add Adv Section 2</li>
                </ol>
            </div>
                    ...
                    <div class="allcp-form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Add Adv Section 2
                                </div>
                            </div>
                            <div class="panel-body br-t">
                            <div class="allcp-form theme-primary">

                            <form method="post" action="{{ url('admin/adv_sec_2') }}"  enctype="multipart/form-data">
                                {{ csrf_field() }}
