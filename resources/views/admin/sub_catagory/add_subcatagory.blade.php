         ...
         <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Add Sub Category</li>
                </ol>
            </div>
                    ...
                    <div class="allcp-form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">Add SubCategory
                                </div>
                            </div>
                            ...
                            <form method="post" action="{{ url('admin/addsubcategory') }}"  enctype="multipart/form-data">
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="name" id="business-name" class="form-control" placeholder="Sub Category Name">
                                    </div>
                                </div>
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="sub_category_description" id="business-name" class="form-control" placeholder="Sub Category Description">
                                    </div>
                                </div>
                                ...
                                <div class="section row mb10">
                                    ...
                                    <div class="col-sm-10 ph10">
                                            <input type="text" name="sub_catagory_abbreviation" id="business-name" class="form-control" placeholder="Sub Category Abbreviation">
                                    </div>
                                </div>
